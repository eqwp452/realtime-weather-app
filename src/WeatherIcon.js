...
`;
const weatherTypes = {
  isThunderstrom: [15, 16, 17, 18, 21, 22, 33, 34, 35, 36, 41],
  isClear: [1],
...
const weatherIcons = {
  day: {
    isThunderstrom: <DayThunderstorm />,
    isClear: <DayClear />,
  ...
  night: {
    isThunderstrom: <NightThunderstorm />,
    isClear: <NightClear />,
...
const WeatherIcon = (
  props,
  { currentWeatherCode = props.id, moment = props.moment }
) => {
